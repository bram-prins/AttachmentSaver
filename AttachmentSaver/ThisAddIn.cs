...
namespace AttachmentSaver
{
    public partial class ThisAddIn
    {
        ...
        private void ThisAddIn_Startup(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine(settings.autoEnabled);
        ...
        private Dictionary<string, int> SaveAttachmentsOfMail(Outlook.MailItem mail)
        {
            ...
            if (mail.Attachments.Count > 0)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine(profile.Sender);
                    System.Diagnostics.Debug.WriteLine(mail.SenderEmailAddress);
                    System.Diagnostics.Debug.WriteLine(profile.Sender != mail.SenderEmailAddress);
                    ...
                    foreach (var attachment in mail.Attachments.Cast<Outlook.Attachment>())
                    {
                        ...
                        System.Diagnostics.Debug.WriteLine("Attachment not embedded:");
                        System.Diagnostics.Debug.WriteLine(mail.HTMLBody.Contains(attachment.DisplayName) || string.IsNullOrEmpty(Path.GetExtension(attachment.FileName)));
                        ...
                        System.Diagnostics.Debug.WriteLine(profile.FilenameFilter);
                        System.Diagnostics.Debug.WriteLine(filename);
                        System.Diagnostics.Debug.WriteLine(!string.IsNullOrEmpty(profile.FilenameFilter) && !Regex.IsMatch(filename, profile.FilenameFilter));
                        if (!string.IsNullOrEmpty(profile.FilenameFilter) && !Regex.IsMatch(filename, profile.FilenameFilter))
                            continue;

                        System.Diagnostics.Debug.WriteLine(string.Join(", ", profile.FileExtensions));
                        System.Diagnostics.Debug.WriteLine(fileExtension);
                        System.Diagnostics.Debug.WriteLine(!profile.FileExtensions.Any() && !profile.FileExtensions.Contains(fileExtension));
